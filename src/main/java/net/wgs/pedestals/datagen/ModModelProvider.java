...
import net.wgs.pedestals.block.ModBlocks;
import net.wgs.pedestals.block.PedestalBlock;
...
import static net.wgs.pedestals.block.PedestalBlock.PEDESTAL_MODEL;
import static net.wgs.pedestals.block.PedestalBlock.PEDESTAL_MODEL_MORE;
