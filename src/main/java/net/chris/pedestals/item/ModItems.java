...
public class ModItems {
    ...
    public static final Item GLASS_LOCKBOX = registerItem("glass_lockbox", LockboxItem::new, new Item.Settings()
            .maxCount(1)
            .component(ModComponents.LOCK_AND_KEY_DATA, new LockAndKeyDataComponent(UUID.randomUUID(), false)).component(ModComponents.LOCKBOX_DUST_COMPONENT, new LockboxDustComponent(0)));
