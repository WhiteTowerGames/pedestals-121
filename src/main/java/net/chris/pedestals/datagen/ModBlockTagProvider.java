...
public class ModBlockTagProvider extends FabricTagProvider.BlockTagProvider {
    ...
    public static final TagKey<Block> PEDESTAL_BLOCKS = TagKey.of(RegistryKeys.BLOCK, Identifier.of(Pedestals121.MOD_ID, "pedestal_blocks"));
    ...
    protected void configure(RegistryWrapper.WrapperLookup wrapperLookup) {
        ...
        getOrCreateTagBuilder(BlockTags.PICKAXE_MINEABLE)
                ...
                .add(ModBlocks.RESIN_BRICK_PEDESTAL)
        ...
        getOrCreateTagBuilder(BlockTags.AXE_MINEABLE)
                ...
                .add(ModBlocks.PALE_OAK_LOG_PEDESTAL)
                .add(ModBlocks.STRIPPED_PALE_OAK_LOG_PEDESTAL)
        ...
        ALL_FANCY_CARPETS.forEach(block -> getOrCreateTagBuilder(BlockTags.WOOL_CARPETS).add(block));
    }
