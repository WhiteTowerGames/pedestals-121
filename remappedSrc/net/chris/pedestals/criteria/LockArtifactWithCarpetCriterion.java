...
public class LockArtifactWithCarpetCriterion extends AbstractCriterion<LockArtifactWithCarpetCriterion.Conditions> {
    ...
    @Override
    public Codec<net.chris.pedestals.criteria.LockArtifactWithCarpetCriterion.Conditions> getConditionsCodec() {
        return net.chris.pedestals.criteria.LockArtifactWithCarpetCriterion.Conditions.CODEC;
    }
    ...
    public record Conditions(Optional<LootContextPredicate> playerPredicate) implements AbstractCriterion.Conditions {
        ...
        public static Codec<LockArtifactWithCarpetCriterion.Conditions> CODEC = RecordCodecBuilder.create(instance -> instance.group(
                LootContextPredicate.CODEC.optionalFieldOf("player").forGetter(net.chris.pedestals.criteria.LockArtifactWithCarpetCriterion.Conditions::player)
        ).apply(instance, net.chris.pedestals.criteria.LockArtifactWithCarpetCriterion.Conditions::new));
